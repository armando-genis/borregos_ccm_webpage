...
import mypic6 from '../public/ebc06_car.png';
import mypic7 from '../public/ebc05_car2.png';
...
export default function Aboutus() {
    return (
        <div className="min-h-screen min-w-screen relative overflow-hidden flex flex-col items-center ">
            ...
            <div className="relative h-[100px] w-[0.15rem] bg-white bg-gradient-to-b from-[#000] to-blue-600"></div>
            <div className="relative inline-flex items-center justify-center rounded-full w-[40px] h-[40px] bg-gradient-to-b from-blue-600 to-[#00DFD8] font-bold text-black">1</div>
            <div className="relative text-[2rem] text-transparent bg-clip-text bg-gradient-to-b from-[#007CF0] to-[#00DFD8] font-bold">About us</div>

            {/* content */}
            <div className="relative bg-[#ffffff12] w-full lg:w-8/12  rounded-lg shadow-[#0000001a] drop-shadow-2xl z-[2] p-6 mt-4">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="w-full md:w-1/2">
                        <p className="pl-10 tracking-tight font-display font-semibold text-3xl text-left text-slate-100">Hello, this is</p>
                        <p className="pl-10 tracking-tight font-display font-bold text-6xl text-left text-slate-100">Borregos ccm</p>
                        <p className="pl-10 pt-6 font-display font-light text-xl md:text-2xl text-left text-slate-100">The team is a group of people which are dedicated to the manufacture of electric cars with the purpose of participating in competitions around the country, this has different areas with multiple knowledge for its participants which are constantly nourished by experiences and learning </p>
                    </div>
                    <div className="w-full md:w-1/2 inline-flex items-center justify-center">
                        <Image
                            src={mypic6}
            ...
            <div className="uppercase text-[#888] pt-5 tracking-[.2rem]">
                <h1>Overview</h1>
            </div>
            <div className="w-full md:w-8/12 flex flex-row items-center justify-between py-4">
                <div className="text-center h-[6rem] w-[calc(100% / 5)] md:w-auto">
                ...
                <div className="w-[0.15rem] h-[6rem] bg-white/20 hidden md:block"></div>
                <div className="text-center h-[6rem] w-[calc(100% / 5)] md:w-auto">
